...
export function FirebaseAuthDialog({
  ...
  const handleFirebaseSignOut = async () => {
    ...
    try {
      ...
      toast.success(
        "Signed out successfully. Now sign in with the correct account."
      );
    } catch (error) {
            ...
            <div className="space-y-4">
              <Alert className="border-orange-200 bg-orange-50">
                ...
                <AlertDescription className="text-orange-800">
                  ...
                  <p className="mt-2">
                    You need to sign out of your current Firebase account first,
                    then sign in with the correct account.
                  </p>
                  {requiredFirebaseUid && (
                    <div className="mt-2 text-sm">
                      <p>
                        <strong>Required Firebase UID:</strong>{" "}
                        <code className="bg-orange-100 px-1 rounded">
                          {requiredFirebaseUid.slice(0, 12)}...
                        </code>
                      </p>
                      {currentEmail && (
                        <p>
                          <strong>Required Email:</strong> {currentEmail}
                        </p>
                      )}
                    </div>
                  )}
              ...
              {requiredFirebaseUid && (
                <Alert className="border-blue-200 bg-blue-50">
                  ...
                  <AlertDescription className="text-blue-800">
                    ...
                    <p className="mt-2">
                      You need to sign in with the specific Firebase account
                      that owns this Nostr identity.
                    </p>
                    <div className="mt-2 text-sm">
                      <p>
                        <strong>Required Firebase UID:</strong>{" "}
                      ...
                      {currentEmail && (
                        <p>
                          <strong>Linked Email:</strong> {currentEmail}
                        </p>
                      )}
                    </div>
                    <p className="mt-2 text-sm">
                      Please sign in with the correct account credentials.
                    </p>
                  </AlertDescription>
                </Alert>
              )}
