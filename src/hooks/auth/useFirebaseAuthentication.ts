 ...
 */
function validatePassword(password: string, isSignUp: boolean = false): { isValid: boolean; error?: string } {
  if (!password) {
 ...
 */
export function isValidPassword(password: string, isSignUp: boolean = false): boolean {
